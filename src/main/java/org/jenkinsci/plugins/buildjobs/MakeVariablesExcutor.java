...
public class MakeVariablesExcutor {
    private static final Logger LOGGER = Logger.getLogger(MakeVariablesExcutor.class.getName());

    private String jobs;
    private int choicenumber;
    private List<ScheduledJobs> otherJobs; // 存放其他 job的。 可以自定义时间段来决定是否使用这些job

    public MakeVariablesExcutor(int choicenumber, String jobs, List<ScheduledJobs> otherJobs) {
        this.jobs = jobs;
        this.otherJobs = otherJobs;
        this.choicenumber = choicenumber;
    }

    public void makeVariables(Run<?, ?> build, TaskListener listener, Map<String, String> variables) {
